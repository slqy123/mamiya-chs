...
; 「良太、サングラスを見ませんでした？　お母様から␤いただいたものなんですけど」
「良太，你有看到一副太阳镜吗？
那个是母亲大人给我的」
@Hitret id=35772
@Talk name=良太
; 「ああ、莉里香のだったのか。そこのカウンターに␤置いておいたよ」
...
@Talk name=心の声
; カウンターの方を指さすと、莉里香は慌てた様子で␤確認しに行った。
我指了指柜台的方向，莉里香慌忙前去确认。
@Hitret id=35774
@char file=CE05B001M
@おじぎ id=莉里香
...
@Hitret id=35775
@Talk name=良太
; 「そういえば、日差し対策にってサングラスを␤幾つかもらっていたな」
「说起来，为了防晒你父母给了你好几副太阳镜呢」
@Hitret id=35776
@回想背景のみ bg=BG02a01
@Talk name=心の声
; 四条院さんたちが来て、莉里香のアルバイト姿を␤見てもらったのがほんの数日前。
几天前，四条院夫妇来看了莉里香打工的样子。
@Hitret id=35777
@char file=CE06A001M tone=sepia
@Talk name=心の声
; 莉里香の仕事っぷりを目の当たりにして、ご両親は␤とても驚いたようだった。
看到莉里香工作的样子，父母似乎非常吃惊。
@Hitret id=35778
@char file=CE06A006M
@Talk name=心の声
; 『ぜひともこのままアルバイトを続けさせてほしい』と␤ご両親の方からお願いされてしまったくらいだ。
甚至还拜托我“请务必让她在这里继续打工”。
@Hitret id=35779
@Talk name=心の声
...
; 「浜之崎で暮らすことを許してもらって、アルバイトを␤続けることになって……そして今日で海の家が最後だ␤なんて、不思議な気分ですわ」
「得到了继续住在浜之崎的许可，打工也可以继续进行下去……
然后今天就是海之家的最后一天，真是不可思议的感觉啊」
@Hitret id=35781
@Talk name=良太
; 「確かに、今年は夏休みがあっという間に過ぎていった␤気がするよ」
「确实，今天的夏天真是一转眼就过去了」
@Hitret id=35782
@char file=CE05B001M
@Talk name=莉里香 voice=RRK051234
; 「ええ。私もこんなに早く過ぎていった夏休みは初めて␤です」
「是啊。我也是第一次经历这么快就结束的暑假」
@Hitret id=35783
@Talk name=心の声
; 忙しかったせいだと拗ねているのかと思えば、莉里香は␤清々しい表情をしていた。
我原以为她会因为工作太忙而闹别扭，
但莉里香的表情却十分清爽。
@Hitret id=35784
@Talk name=良太
...
; 「だって、とても充実していたんですもの。こんなに␤素敵な夏休みは初めてでしたから」
「因为这个暑假实在是太充实了。
我还从来没有过过这么棒的暑假呢」
@Hitret id=35786
@char file=CE05B003M
@Talk name=莉里香 voice=RRK051236
; 「それまでは、宿題が三倍あったって足りないほど␤退屈でしたのに」
「换做之前，就算暑假作业多上三倍我都觉得无聊」
@Hitret id=35787
@Talk name=心の声
; どんなに暇だからって、宿題じゃ暇つぶしにもならないと␤思うけど。
就算再无聊，也不能拿作业来打发时间吧。
@Hitret id=35788
@char file=CE05B012M
...
; 「たくさんの思い出が詰まっているお店ですわ。私が␤初めてアルバイトをして……それに……」
「这家店承载着我无数美好的回忆。
这是我第一次打工的地方……同时……」
@Hitret id=35794
@stopEnvSe fade=1000
...
; 「テラスで……初めて夜空の下でセックスをした␤場所でもありますし……」
「在这里，露天席……
这也是我们在夜空下第一次做爱的地方……」
@Hitret id=35795
@メッセージ揺らし
...
; 「ですが……ここで二人きりになれるのは、今だけですわ。␤もうすぐ開店ですし、後片付けは皆さんでやります␤でしょう？」
「但是……两人独处的时间，只有现在了。
...
@clearChar id=-1
@Talk name=心の声
; エプロンが汚れてしまわないように外して、俺たちは␤もう一度抱き締め合った。
为了不弄脏衣服而脱下了围裙，
我们再次紧紧地拥抱在一起。
@Hitret id=35815
