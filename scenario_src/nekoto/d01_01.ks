...
「话说，就不考虑让她来占卜一样店的问题吗？
像是电视上的占卜师一样，预测股票和竟马什么的」
@Hitret id=25483
@Talk name=良太
@Sub mess="「頼めば占ってくれるだろうけど、嫌がるんじゃないかな」"
「拜托的话也不是不行，不过，多少还是有些抗拒吧」
@Hitret id=25484
@char file=CI02A008M
...
「占卜是用来给予人向前的勇气，激发人加油的动力，
而不是用来实现特定的目的的。这是音琴的信条」
@Hitret id=25489
@char file=CI02A002M
@おじぎ id=六兵衛
...
就拿我们班来说，京花老师每次都会在打铃前
稍微早一点到达教室，因此音琴的判断很正确。
@Hitret id=25499
@autoPosition
@Talk name=良太
@Sub mess="「今日も占いは絶好調か？」"
...
音琴一定是在用不违背自己信条的方式，
为那些来需求占卜的女生们提供背后的支持吧。
@Hitret id=25547
@Talk name=良太
@Sub mess="「八雲姉は八雲姉で、相変わらず助っ人で引っ張りだこ␤みたいだな」"
「八云姐姐也还是老样子，到处帮忙很受欢迎呢」
@Hitret id=25548
@char file=CC02A006M
...
「你，你喜欢上谁都和我没什么关系。
当然如果我们能两情相悦地结婚那就最好了，不过你要是
在和我相处的过程中重新喜欢上了我也是没关系的！」
@Hitret id=25739
@char file=CE02A014M
