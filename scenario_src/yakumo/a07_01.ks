...
@Hitret id=12390
@Talk name=心の声
; しかし気温が下がるようなことはなく、逆に蒸し暑くて␤息苦しいくらいだ。
但是气温非但没有下降，
反而闷热得让人喘不过气来。
@Hitret id=12391
@stopEnvSe fade=1000
...
@char file=CD06A006M
@Talk name=心の声
; トレイにクリームソーダを載せようとすると、音琴は␤じっと俺の顔を見つめてきた。
当我把奶油苏打装盘的时候，
却发现音琴一直盯着我的脸看。
@Hitret id=12394
@Talk name=良太
...
@Hitret id=12405
@Talk name=良太
; 「大丈夫だよ。うさぎじゃあるまいし、寂しくて␤どうこうなったりしないから」
「没关系哦。我又不是兔子，
只是稍微寂寞一点死不了的」
@Hitret id=12406
@char file=CG06A008M
...
@Hitret id=12410
@Talk name=心の声
; 昨日は無事に到着したという連絡があって、家族みんなで␤代わる代わる電話で話をした。
八雲姐姐昨天到学校后给家人报了个平安，
轮流给家里人都打了个电话。
@Hitret id=12411
@Talk name=心の声
...
@Hitret id=12413
@Talk name=心の声
; きっといろいろ見聞きしたことを、今日も電話で␤話してくれるはずだ。
肯定会有很多新的见闻吧，
今天也会打电话和我们娓娓道来的吧
@Hitret id=12414
...
; 「注文されたものなら、早く運ばないとアイスが␤溶けちゃうでしょ？　ぼーっとしてたら駄目じゃない」
...
; 「雨のおかげで、こっちのシーモアの売り上げも␤あがりそうだもの」
「多亏了下雨，这边的西摩尔看起来销量会上升呢」
@Hitret id=12425
@Talk name=良太
; 「雨の日だと観光客の人たちも行く場所がなくて␤手持ちぶさたになるもんな」
「下雨天游客们没有地方去所以就闲下来了呢」
@Hitret id=12426
@clearChar id=-1
@Talk name=心の声
; 常連さんが少なくなる代わりに、散歩のついでに␤ひと休みしようというお客さまが来てくれる。
虽然常客们来得更少了，
但散步的同时顺便来这里休息的游客们多了起来。
@Hitret id=12427
@Talk name=心の声
; 初めて来店するお客さまが多いから、普段以上に神経を␤遣う日でもある。
但因为有很多客人都是第一次来的，
所以今天并以往都要费神。
@Hitret id=12428
@char file=CB06A009M
...
; 「もう、自覚がないわけじゃないんでしょ？　八雲に␤メールでもして、少し心を持ち直した方がいいわ」
「真是的，你还真就是没有自觉啊？
...
; 「八雲のドジほどじゃないけど……二人一緒じゃないと␤本領発揮できないのは、八雲だけじゃないみたいね」
...
@Hitret id=12435
@Talk name=心の声
; お客さまに聞こえないように声を抑えて、萌莉が顔を␤近付けてくる。
萌莉为了不让客人听到而压低了声音，
靠近我并向我说道。
@Hitret id=12436
@Talk name=良太
...
@Hitret id=12437
@Talk name=心の声
; もしもここに八雲姉がいたらヤキモチを妬かれるな、と␤無意識に想像して、急に胸が詰まった。
如果八雲姐姐在这里的话，肯定会吃醋的吧，
我无意识地想象着，突然感觉心里五味杂陈。
@Hitret id=12438
@Talk name=良太
...
; 「ええ。休憩した方がいいって言い出したのはお父さん␤だから、自分から説明したりしなくても大丈夫よ」
「嗯，是爸爸叫你休息的，
所以不需要再和爸爸说明了哦」
@Hitret id=12440
@Talk name=良太
...
@Hitret id=12442
@Talk name=心の声
; 確かに、八雲姉がいなくて不調……だなんて、自分から␤説明するのは少し辛い。
确实，如果八雲姐姐不在的话就诸事不顺……
这样的话，要我自己说明确实有些难以启齿。
@Hitret id=12443
@Talk name=心の声
...
@時間経過３Ｐ bg=BG06a01
@Talk name=心の声
; リビングまで戻る時間が惜しくて、俺は廊下でスマホを␤ポケットから出した。
为了充分利用到客厅的这段时间，
我在走廊上便将手机从口袋里掏了出来。
@Hitret id=12445
@Talk name=心の声
...
@Hitret id=12446
@Talk name=心の声
; こんな中途半端な時間にメールをしたら、店が暇なのかと␤心配されるんじゃないか？
在这样一个不上不下的时间发邮件，
会不会让对方担心店里生意冷清？
@Hitret id=12447
@Talk name=心の声
; 近くにいる時はメールの一通くらい全然気にせず␤送れるのに、どうしてこんなに考え込んでしまうんだろう。
明明八雲姐姐在身边的时候，
一封邮件时间完全是小菜一碟，
可为什么现在会这么纠结呢。
@Hitret id=12448
...
@Hitret id=12450
@Talk name=心の声
; なんだかヒヤリとする想像をしてしまって、俺は急いで␤メールを打った。
不知为何生出一种不祥的感觉，
我急忙回过神来敲起了邮件。
@Hitret id=12451
@Talk name=心の声
...
@Talk name=心の声
; 八雲姉からの返信を確認することなく、昼のピークで␤意識も身体ももみくちゃにされる。
整个午高峰我都没有确认八雲姐姐的回信，
不管是意识和身体都是完完全全的一团浆糊。
@Hitret id=12455
@Talk name=心の声
...
@Hitret id=12456
@Talk name=心の声
; それでも、お客さまが一組帰り、二組帰り……店内が␤落ち着いてくるとどうしても思考がぶれる。
然而，随着客人们一个接一个地离开，
...
@stopSe fade=1000
@Talk name=心の声
; この時間帯、八雲姉ならどう働いているかなんてことは␤簡単に想像できてしまう。
稍微想象一下，脑海中就清楚地浮现出
八雲姐姐现在工作的样子。
@Hitret id=12476
@Talk name=心の声
; 空いている席のテーブルを綺麗に拭いて、ナプキンを␤補充して……
把空座位的桌子擦洗干净，再补充餐巾……
@Hitret id=12477
@Talk name=心の声
; ほんのちょっと時間を見つけては、厨房で何かつまみ食い␤したりもする。
稍微有些空闲的话，也会去厨房拿点吃的吃。
@Hitret id=12478
@Talk name=心の声
...
@Hitret id=12479
@Talk name=心の声
; そう微笑ましく考えたことを思い出して、ますます␤八雲姉が恋しくなってくる。
想到这些令人开心的事情，
心中愈发地思念起了八雲姐姐。
@Hitret id=12480
...
@Hitret id=12484
@Talk name=心の声
; 物思いに沈んでいたからか、無意識のうちに店の奥へと␤向かっていたみたいだ。
也许是我想入神了吧，四条院同学
不知不觉便出现在了店里的角落。
@Hitret id=12485
@char file=CE03A008M
@Talk name=莉里香 voice=RRK010092
; 「八雲さんと離れてしまって、寝込んでいるかと␤思ってましたわ」
...
@Hitret id=12488
@Talk name=心の声
; 離れてまだ少ししか経ってないのに気持ちがこんなにも␤ざわつくなんて、やっぱり依存なんだろうか。
才分开了这么点时间心情就变得如此不安，
果然是因为依赖吗。
@Hitret id=12489
@char file=CE03A012M
...
; 「八雲さんをお送りする時、私も同乗しましたの。一緒に␤少し見学して、私は戻りましたけど……その時に␤いろいろお話を聞いたんですわ」
「之前送八雲同学的时候，我也一起陪她过去了。
和她一起稍微参观了一会，那个时候听她说了很多话」
@Hitret id=12492
@char file=CE03A010M
@Talk name=莉里香 voice=RRK010095
; 「家族旅行も修学旅行も一緒だったし、一緒に生まれて␤から何日も離れたことなんて無い、って」
「说什么不管是家庭旅行还是修学旅行都是一起，
打出生开始就没有一天分开过什么的」
@Hitret id=12493
@char file=CE03A012M
@Talk name=莉里香 voice=RRK010096
; 「八雲さんはとても寂しそうでしたわ。人生で一番長い␤一週間になりそうだって言ってましたもの」
「八雲她看起来可寂寞了。还说什么
这会是我人生中最漫长的一个星期」
@Hitret id=12494
@Talk name=良太
; 「そうですね……家族と離れること自体、俺にも八雲姉に␤とっても初めてのことですから」
「是啊……家人的离开，不管是对于我
还是八雲姐姐来说，都是第一次经历」
@Hitret id=12495
@Talk name=良太
...
; 「私の両親は、昔から仕事で不在がちですもの。␤あなたたちのように、ずっと一緒にいて␤離ればなれになるのとは訳が違いますわ」
「我的父母从很久以前就经常不在家了。
和你们这些从来没有分开过的情况不一样」
@Hitret id=12497
@char file=CE03A010M
...
@Hitret id=12512
@Talk name=心の声
; こういう場合、正直でいることが彼女への最大の攻撃に␤なるみたいだ。
...
; 「良太、注文まだ聞いてなかったでしょ。サボってちゃ␤駄目じゃない」
「良太，你还没点单吧。可不能偷懒哦」
@Hitret id=12514
@autoPosition
@Talk name=良太
...
; 「そういえば、注文を忘れてましたわね。良太が珍しく␤露骨に鼻の下を伸ばしたので、つい話し込んで␤しまいましたわ」
「这么说来，我把点单给忘了呢。
难得看到良太色眯眯的样子，
一个不留神就把正事忘了」
@Hitret id=12516
...
@Hitret id=12520
@Talk name=心の声
; 互いの様子がすぐに見られない八雲姉へ、いらない心配は␤かけたくない。
接下来很长一段时间都不能和八雲姐姐相见，
还是不要让她担心了比较好。
@Hitret id=12521
@Talk name=心の声
...
@Hitret id=12524
@Talk name=心の声
; 『いつでも撮れるから』……なんていう、家族的な意識が␤ぬけないせいだろうか。
肯定是想着反正什么时候都能拍，
...
@Hitret id=12529
@Talk name=心の声
; そういう存在感があるからこそ、いない時の寂しさも␤ひとしおなんだ。
正因为存在感如此之强，
八雲姐姐不在的时候
也会感受到同等程度的寂寞。
@Hitret id=12530
...
@Hitret id=12532
@Talk name=心の声
; デートをした時には見たけど、やっぱりエプロン姿の方が␤見慣れてるせいか、攻撃力抜群だ。
虽然约会的时候也看到过，
但是果然是平时都穿着围裙的缘故吗，
这样的泳装反而冲击力更强。
@Hitret id=12533
...
@Hitret id=12536
@Talk name=心の声
; 一度八雲姉の身体を思い出すと、なかなか頭から␤離れてくれなくなる。
一想起八雲姐姐的身体，便如何也无法从脑海中忘却。
@Hitret id=12537
@face file=CD06A006
@Talk name=音琴 voice=NKT010099
; 「八雲お姉ちゃんの肌……すべすべできれい？　プールの␤消毒に負けたりしてない？」
「八雲姐姐的皮肤……滑溜溜的漂亮吗？
不会被游泳池的消毒水而影响了吧？」
@Hitret id=12538
@Talk name=良太
...
@Hitret id=12541
@Talk name=心の声
; 普段と違って、少し子どもっぽいような声で甘えて␤くるのがすごく可愛いんだよな……
和平时有些不同，这种稍微有些孩子气的
撒娇般的声音也好可爱啊……
@Hitret id=12542
@Talk name=心の声
...
@Hitret id=12545
@Talk name=心の声
; 店内なのに妄想が捗ると思ったら、誘引剤が目の前に␤立っていた。
我还想着为什么明明在店里却妄想得如此顺利，
原来是因为催化剂就在眼前。
@Hitret id=12546
@char file=CD06A015M
@Talk name=音琴 voice=NKT010100
; 「ずっといたよ。お兄ちゃんが八雲お姉ちゃんのこと␤考えてる顔してたから、いつ気付くかなって思って␤たけど……」
「一直都在哦。从欧尼酱露出了
在想着八雲姐姐的表情开始，
我还想着欧尼酱要什么时候才会注意到呢……」
@Hitret id=12547
...
; 「ふふふ。八雲お姉ちゃんが、メールを喜ぶ確率は␤１００パーセント。だから返事も良い内容のはず、だよ」
「呵呵呵。八雲姐姐喜欢短信的概率是100%。
所以回复也会是好的内容，哦」
@Hitret id=12556
@Talk name=良太
...
@Hitret id=12563
@Talk name=心の声
; すでに全部自分でこなせてる八雲姉に比べたら、こんなの␤努力の内とも言えないんだろうけど。
和全部都是一个人完成的八雲姐姐相比，
这样的东西也说不上努力吧。
@Hitret id=12564
@Talk name=良太
...
@Hitret id=12566
@Talk name=心の声
; 昼間送った八雲姉の返信は『学校の周りは晴れ』なんて␤天気の報告だけだった。
白天发给八雲姐姐的邮件
收到的回复只有“学校这里是晴天”
这样的天气报告而已。
@Hitret id=12567
@Talk name=心の声
; 返信する前に、家族への報告電話が入ったから␤タイミングをなくしてしまっていた。
...
@Hitret id=12581
@Talk name=心の声
; 八雲姉の声は、恋人としての通話だからか、どこか␤雰囲気が違っていた。
八雲姐姐的声音，是因为是恋人之间的通话的缘故吗，
总觉得氛围有些不太对劲。
@Hitret id=12582
@Talk name=心の声
; 何て声をかければいいのか迷っているうちに、ふと␤気付くことがあった。
正当我在犹豫该说什么的时候，
忽然注意到了一件事。
@Hitret id=12583
@Talk name=良太
...
@Hitret id=12585
@Talk name=良太
; 「もう虫が鳴いてるんだな。八雲姉の電話口から␤聞こえてきてる」
「八雲姐姐那里有昆虫在叫哦，从电话里可以听到」
@Hitret id=12586
@Talk name=心の声
; 沈黙に耳をすますと、鈴の音のような聞き慣れない␤音がしていた。
我倾听着电话那边的静谧，
那是一种如铃声般清脆但又陌生的声音。
@Hitret id=12587
@face file=CA04A001M
...
@Hitret id=12588
@Talk name=良太
; 「へえ、海の街で過ごしてきた身からすると␤なんだか新鮮だな」
「哦，对于在海边长大的人来说，
这样的感觉还是真是新鲜呢」
@Hitret id=12589
@face file=CA04A011M
@Talk name=八雲 voice=YKM010990
; 『そうですね。うちからだと、窓を開けてたら波の音が␤聞こえてきますもんね』
『是啊。不过家里也是类似呢，
打开窗户就能听到海浪的声音』
@Hitret id=12590
@Talk name=良太
...
; 『網戸してるから大丈夫ですよ。それに、もう虫に␤刺されちゃってるから、手遅れなんです』
『有纱窗所以没关系哦。而且，已经晚了，
早就已经被虫子叮得遍体鳞伤了』
@Hitret id=12596
@Talk name=良太
...
@Hitret id=12606
@Talk name=心の声
; 少し呆れたものの、八雲姉の声がとても寂しそうなのは␤はっきりと伝わってきた。
虽然有些吃惊，但从八雲姐姐的声音中，
我还是清楚地感受到了她的寂寞。
@Hitret id=12607
@Talk name=心の声
; だから“いつも通り”を再現するために、八雲姉が俺を␤からかおうとしているのが分かった。
所以，为了再现那种“和平常一样”的感觉，
八雲姐姐才会如此捉弄我。
@Hitret id=12608
@face file=CA04A004M
...
@Hitret id=12614
@Talk name=心の声
; 今夜電話をくれたのも、きっと恋人同士の甘い会話を␤したいだけじゃなかったんだ。
今晚给我打电话，我想肯定
不只是恋人之间的甜蜜聊天吧。
@Hitret id=12615
@cg file=SD_A02b
...
; 『そうそう、良ちゃんが応援しにきてくれたから、すごく␤はりきっちゃって』
...
@Hitret id=12621
@Talk name=良太
; 「でも、別の試合でコースから外れて斜めに泳いだって␤話してたよな。その時は俺、見に行けなかったけど」
「但是，我听说你在一场其他的比赛中
游出了泳道，游成了斜线呢。
不过当时我没能去看」
@Hitret id=12622
...
@Hitret id=12623
@Talk name=心の声
; ただ、俺は実際にそんな姿を見たことがないから␤半信半疑だった。
只是，我也没有实际看到过那样的情景，
所以有些半信半疑。
@Hitret id=12624
@face file=CA04A009M
@Talk name=八雲 voice=YKM011002
; 『今日も少し泳がせてもらったんです。そしたら水泳部の␤コーチの人が褒めてくれたんですけど……やっぱり、␤ちょっと感覚が違うっていうか……』
...
; 『そうですね。良ちゃんがここにいてくれたら、もっと␤楽しく泳げたんじゃないかな……』
『是啊。如果小良在的话，
会不会可以游得更开心呢……』
@Hitret id=12629
@face file=CA04A014M
...
@Hitret id=12635
@Talk name=心の声
; 俺と話していて気付いたなら、何か協力できることが␤あるのかもしれない。
既然是在和我说话的时候注意到的，
说不定我也能帮上什么忙。
@Hitret id=12636
@Talk name=心の声
...
@Hitret id=12642
@Talk name=心の声
; 大人しく目を瞑っていると、電話の向こうでもごもごと␤逡巡するような息遣いが聞こえてきた。
...
@Hitret id=12657
@Talk name=心の声
; 聞く分には気恥ずかしいだけだけど、自分からするのは␤勇気がいる。
这话听起来满满的都是害羞，
真的要主动去做的话，还是很需要勇气的。
@Hitret id=12658
@cg file=SD_A02b
...
; 『えー、してくれないんですか？　恋人の␤八雲お姉ちゃんにキスするのはいやですか？』
『欸——不行吗？是讨厌
和作为恋人的八雲姐姐亲嘴吗？』
@Hitret id=12659
@Talk name=心の声
; 電話の向こう側で、八雲姉はきっとわざとらしいくらい␤拗ねた顔をしてるはずだ。
可以想象，电话的那一边，八雲姐姐肯定是
一副故意做出来的别扭的表情。
@Hitret id=12660
@Talk name=心の声
; 簡単に想像できてしまって、その想像が絶対に正解だと␤自信を持って言えるけど、確かめることができないのは␤もどかしい。
虽然能简单地想象到，而且我也很有自信肯定没有猜错，
但不能亲自确认一下还是让人心里痒痒的。
@Hitret id=12661
@face file=CA04A004M
@Talk name=八雲 voice=YKM011015
; 『キスしてください……ちゅって、一回だけでもいいです␤から……キス、してほしいです』
『请亲我……啾，就一次也好……想要亲亲』
@Hitret id=12662
@Talk name=心の声
; 沈黙が耐えられなくなったのか、八雲姉の声はだんだん␤切なそうな雰囲気を増していく。
...
; 『ふふふー、もう閉じてますっ！　さあさあ、ちゅーして␤ください。思う存分、いっぱいいっぱい、ちゅーして␤くださいね』
...
; 『うふふ、一回で私をイかせちゃうくらい、濃厚で濃密で␤愛に満ちたキスをするぞっていう宣言ですね？』
『诶嘿嘿，也就是说，你能给我一个能让我
一次就高潮的，浓密而充满爱意的亲吻吗？』
@Hitret id=12671
@Talk name=良太
...
@Hitret id=12676
@Talk name=心の声
; これが何かの解決になるかは分からないけど、恋人として␤慰めるっていうのはこういうことなのかもしれない。
虽然不知道这样做到底有什么用，
但也许恋人之间的互相安慰就是这样的吧。
@Hitret id=12677
@Talk name=心の声
...
; 『えへへ、恥ずかしいけど、ちゅーしてくれるんですよね。␤優しい優しい彼氏さんは、寂しがりやな彼女に␤ちゅーしてくれるんですよね？』
『虽然很羞耻，但还是会为我做的吧。
我温柔的男朋友，为了安慰彼方寂寞的女友，
会亲的吧？』
@Hitret id=12683
...
; 『ふふふっ、不意打ちです。恥ずかしがってるところも␤かわいいですよっていう、ちゅーです』
...
@Hitret id=12698
@Talk name=心の声
; とても他人に聞かせられないような、恥ずかしいこと␤ばかりだったけど……
虽然聊的尽是一些不可描述的害羞的事情……
@Hitret id=12699
@Talk name=心の声
; 電話をしている間は、ほんの少しだけ寂しさが癒されたの␤だった。
但这段宝贵的通话时间，
却多少让我缓解了心中的寂寞。
@Hitret id=12700
