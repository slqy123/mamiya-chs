...
但是，为了让八云姐姐能够一直这样闪闪发光地笑下去，
我也必须坚定自己的道路并走下去啊。
@Hitret id=10953
@Talk name=心の声
@Sub mess="八雲姉の輝きに負けないように、俺も自信を持たないと␤いけない。"
为了不输给八云姐姐的光辉，我也必须要自信起来。
@Hitret id=10954
@Talk name=心の声
@Sub mess="そんな風に思った。"
我如此想着。
