...
@Hitret id=10621
@Talk name=心の声
; ありがたいことに、六兵衛はシーモアに足繁く通って␤くれているから。
令我十分感激的是，六兵卫这个暑假经常光顾西摩尔。
@Hitret id=10622
@char file=CI02A007M
@Talk name=六兵衛 voice=RKB010018
; 「なんだよ、少しくらい感動の再会を演出してくれても␤いいだろ？」
...
@Hitret id=10626
@Talk name=心の声
; 軽くあしらおうとしただけなのに、こうも感動されると␤ちょっと胸が痛む。
我原本只是想随便应付一下就是了，
...
@ううっ id=莉里香
@Talk name=心の声
; 俺が少し緊張したのを察したらしく、四条院さんは␤クスリと微笑んだ。
...
; 「はっきりと勝負の結果が出るまで、諦めるつもりは␤ありませんもの！」
「在赌局的结果分晓之前，
可是不会这么简单地轻言放弃的！」
@Hitret id=10633
@メッセージ揺らし
...
@Hitret id=10641
@Talk name=心の声
; 四条院さんと八雲姉は、顔を見合わせて、クスクスと␤笑い始めた。
四条院和八雲姐姐互相对视，随后开心地笑了起来。
@Hitret id=10642
@fadeEnvSe id=SE115 vol=100
@Talk name=心の声
; 夏休み前とは打って変わった仲の良さに、クラスメイトが␤驚いている。
...
@Hitret id=10644
@Talk name=心の声
; そういえば、六兵衛にはまだ八雲姉とのことを話して␤なかったな。
...
@Hitret id=10648
@Talk name=心の声
; 京花先生も夏休みにしょっちゅう会っていたせいか␤先生として教卓に立ってる姿は新鮮に見える。
也许是暑假经常见面的缘故，
看到京花老师站在讲台上的身影感觉很新鲜。
@Hitret id=10649
@Talk name=心の声
...
@playEnvSe file=SE115 vol=50
@Talk name=心の声
; いきなりの問いかけに、静かになったばかりの教室内が␤ざわめく。
突如其来的提问，让刚刚安静下来的教室
立刻又变得嘈杂起来。
@Hitret id=10652
@char file=CF03A004M
...
@Hitret id=10653
@Talk name=心の声
; 京花先生は、生徒たちの反応で宿題の進み具合が悪い␤ことを察したらしい。
京花老师似乎从学生们的反应中察觉到了
暑假作业的完成情况并不乐观。
@Hitret id=10654
@Talk name=心の声
...
; 「達成感は、大人になってからきっと心の支えになって␤くれるわ。将来どんなお仕事をするにしても、最後まで␤やり遂げる力っていうのは一番大切なことなんだから」
...
@Hitret id=10660
@Talk name=心の声
; 八雲姉に釣り合うような、恥ずかしくないような将来の␤道を描きたい。
...
@Hitret id=10662
@Talk name=心の声
; むしろ、今持てる目標としては最有力で、しっくりきてる␤夢だった。
...
; 「それでは、体育館に移動しましょう。おしゃべりは␤集会の後で、たっぷりしてね」
「好了，少说闲话了，接下来一起去体育馆吧。
等集会结束后随你们怎么说都行」
@Hitret id=10665
...
; 「ねこちゃん、それじゃなにか含みがある感じに␤なっちゃうよ」
「neko酱，你这话很容易让人误解哦」
@Hitret id=10673
@Talk name=良太
; 「二人とも、いつの間に。っていうか、そんな意味深な␤ことじゃないから」
「你们两个，什么时候凑上来的。
还有，才没有什么特别的意思别误解了」
@Hitret id=10674
@clearChar id=珠音
...
; 「ええっ、そんなぁ、ひどいです。八雲お姉ちゃんを␤見捨てるんですか？」
「欸欸，怎么这样，太过分了。
你真的忍心就这样抛弃八雲姐姐吗？」
@Hitret id=10680
@Talk name=良太
...
; 「なんだあの余裕は……いつもなら慌ててどっちも␤ひっぺがすところじゃないか」
...
; 「お兄ちゃん、六兵衛に用事って……八雲お姉ちゃんとの␤こと？」
「欧尼酱，和六兵卫要谈的……是关于八雲姐姐的事吗？」
@Hitret id=10687
@Talk name=心の声
; 眠たげな顔をしてたのに、音琴はズバリと確信を突いて␤きた。
...
; 「はい。デートの時、白井くんにも話すって話し合い␤ましたもんね」
「嗯。之去约会的时候也和白井同学说了说话呢」  ; TODO 对应的是哪一段
@Hitret id=10690
@Talk name=良太
; 「ああ。もし六兵衛が受け入れてくれなくても、八雲姉に␤迷惑はかからないようにするから」
「是啊。就算六兵卫不能接受，
我也不会给八雲姐姐增添困扰的」
@Hitret id=10691
@clearChar id=音琴
...
; 「そうですよ。疑いながら話せば、相手にも疑われちゃい␤ます。警戒しながら話せば、相手にも警戒されちゃい␤ますよ」
...
; 「それに私に迷惑が、なんて言っても駄目なんです！␤恋人同士は一心同体、なんでも共有するもの␤なんですからっ」
「还有就是会给我添麻烦什么的话，也不能说！
身为恋人就要做到一心同体，
不管是什么东西都应该两人共有」
@Hitret id=10697
...
@clearChar id=-1
@Talk name=心の声
; そうだ。六兵衛は一番俺のことを気にかけてくれる男友達␤だからこそ、八雲姉とのことを話そうと思ってるんだ。
是啊。正因为六兵卫是我最重要的男性朋友，
我才想向他说明我和八雲姐姐的事啊。
@Hitret id=10699
@Talk name=心の声
...
@Hitret id=10700
@Talk name=良太
; 「八雲姉がこうして俺に話してくれるみたいに␤話せばいいってことだな」
「那就照八雲姐姐和我说的那样，
和六兵卫也这么说就好了吧」
@Hitret id=10701
@char file=CD02A009L
...
@Hitret id=10705
@Talk name=良太
; 「どうして？　純粋に信頼して話すって、八雲姉が俺に␤してくれてることじゃないか」
「为什么？　只是出于纯粹的信赖向他坦白，
八雲姐姐也是这么和我说的吧」
@Hitret id=10706
@char file=CA02A009L
...
; 「私の信頼は、恋人への信頼ですっ！　恋人専用の信頼␤なんですから、他の人に使っちゃ駄目なんですよ」
「我对你的信赖，是恋人间的信赖！
...
@char file=CD02A008L
@Talk name=心の声
; 八雲姉がへら、と笑うと音琴もほっとしたようにまた␤眠たげな表情に戻った。
...
; 「分かってるなら良いのよ。それに、用事はおしゃべりの␤注意じゃないの。八雲ちゃんを呼びに来たのよ」
...
@Hitret id=10722
@Talk name=良太
; 「夏休み中は問題起こすどころか、部活の助っ人で␤貢献してるくらいなんだから心配いらないよ」
「八雲姐姐暑假不仅没有引起任何问题，
还帮助各个社团作出了那么多贡献，
所以没必要太担心哦」
@Hitret id=10723
...
@Hitret id=10724
@Talk name=心の声
; 首を傾げつつ、俺は音琴を支えながら体育館へと␤再び歩き出した。
疑惑不解的同时，我支撑着音琴继续朝体育馆走去。
@Hitret id=10725
@playBgm file=BGM03 fade=3000
@時間経過１ bg=BG21a01 center=960,720
@Talk name=心の声
; 学園でのホームルームが終わって、俺は六兵衛と一緒に␤屋上へ来ていた。
一切结束后，我和六兵卫来到了屋顶。
@Hitret id=10726
@Talk name=心の声
; 二人で話そうと思っていたのだけど、せっかくなら␤お昼ごはんも食べようとなって、気付けば大所帯に␤なってしまった。
...
; 「正規の部員じゃないのに、いいのかなってちょっと␤申し訳ないんですけどね……」
「明明不是正式的部员，
这样真的好吗，稍微有些对不住就是了……」
@Hitret id=10730
@Talk name=心の声
...
@Hitret id=10732
@Talk name=良太
; 「だから今朝はほとんど教室にいなかったんだな。体育館␤移動の時も、いつの間にかいなくなってたし」
「所以今天早上教室里才根本找不到人呢。
去体育馆的时候也是，一个不留神就不见了」
@Hitret id=10733
@clearChar id=-1
...
; 「風紀委員が街を見回るから、そのお知らせと顔見せ␤だけよ。見回りしてる風紀委員が、逆に通報されたり␤したら困るでしょ」
「因为风纪委员要负责街道巡逻，不过只是走个形式而已。
但毕竟作为巡逻的风纪委员，要是反而因为擅离职守
被通报批评了就麻烦了」
@Hitret id=10734
@Talk name=良太
; 「顔を知られたら、見回りしてることがバレて␤逃げられるような気がするけど？」
「只是走个形式的话，要是巡逻的事被提前知道了，
不是很容易就能逃跑吗？」
@Hitret id=10735
@char file=CB02A011M
@Talk name=萌莉 voice=MER010053
; 「それならそれで抑止力になるからいいのよ。むしろ␤そっちの方が重要ね、抵抗されたり向かって来られたら␤太刀打ちできないもの」
「这样也好，只要能起到威慑作用就行哦。
倒不如说威慑才是最关键的，
要是对方抵抗的话光凭我也不能控制得住啊」
@Hitret id=10736
...
@Hitret id=10738
@Talk name=良太
; 「確かに生徒以外の人からなにかされる可能性もあるし、␤観光客も多くなるしな。なにか困ったことがあったら␤言ってくれよ」
「确实，除了学生以外的人可能会有不怀好意的，
而且观光客也有很多。万一出事的话也可以有照应」
@Hitret id=10739
@Talk name=心の声
; 萌莉は女の子だし、数字の扱いは得意でも体育の成績は␤人並みだ。
萌莉是女孩子，虽然擅长数据的处理，
但体育成绩却很普通。
@Hitret id=10740
@Talk name=心の声
...
; 「もう、八雲が私に話を振るから、心配させちゃった␤じゃない。水泳部の話だったでしょ？」
...
@Hitret id=10744
@Talk name=良太
; 「ああ、フラッシュ炊かれてたな。校内新聞用␤だったのか」
「嗯，用的是闪光灯，确实是校内新闻会用的」
@Hitret id=10745
@clearChar id=-1
@Talk name=心の声
; 八雲姉にファンがいるのは、クラスメイトたちや六兵衛␤から聞いてたから、隠し撮りなんじゃないかとちょっと␤気になっていた。
我从同学和六兵卫那里听说八雲姐姐有一群粉丝，
因此就想着会不会是偷拍什么的。
@Hitret id=10746
@Talk name=心の声
; でも、先生も注意してなかったんだから、学園公認に␤決まってるよな……どうも俺は、独占欲が強いのかも␤しれない。
不过，连老师也没有在意，应该是学校公认的吧……
总感觉我的独占欲好强啊。
@Hitret id=10747
@char file=CE02A001M
@Talk name=莉里香 voice=RRK010037
; 「学生向けのスポーツ新聞にも載ったのでしょう？␤いっそのこと、本当に水泳部に入ってしまえば␤いいですのに」
「面向学生的体育新闻也刊登了吧？
既然如此，干脆直接加入游泳部不就好了吗」
@Hitret id=10748
@char file=CB02A006M
...
@Hitret id=10750
@Talk name=心の声
; 八雲姉はなにか気がかりでもあるのか、少し困ったような␤顔をした。
八雲姐姐似乎是有些顾虑的样子，
露出了略带困扰的表情。
@Hitret id=10751
@Talk name=良太
...
; 「そういうものなんですの？　せっかく表彰されるほどの␤実力があるんですから、もったいない気がします␤けれど……」
「是这样吗？　可我觉得难得有能够被表彰的实力，
就这样浪费了有点可惜……」
@Hitret id=10753
@clearChar id=八雲
@Talk name=心の声
; 四条院さんは納得がいかないらしく、考え込むような␤表情になる。
四条院同学似乎不太能接受的样子，露出了沉思的表情。
@Hitret id=10754
@Talk name=心の声
; 水泳に関しては、直接対決して尚更八雲姉の実力を␤わかってるからかもしれない。
在游泳的话题上，和八雲姐姐亲身对战过的四条院同学
对于八雲姐姐的实力可能会更加了解吧。
@Hitret id=10755
@char file=CE02A010M
@Talk name=莉里香 voice=RRK010039
; 「そういえば、うちが出資している学校で、プールの␤設備が充実しているところがあったような……」
「这么说来，我们家出资赞助的学校里，
好像也有游泳设施非常完备的……」
@Hitret id=10756
@Talk name=良太
...
@Hitret id=10757
@Talk name=心の声
; これ以上八雲姉が困るような話題は避けておくのが無難␤だろう。
还是尽量避免继续谈论会让八雲姐姐困扰的话题吧。
@Hitret id=10758
@clearChar id=-1
@Talk name=良太
; 「六兵衛に話があるんだ。他のみんなはもう知ってること␤なんだけど」
「我有些话想和六兵卫谈谈。
虽然大家有都知道了就是了」
@Hitret id=10759
@char file=CI02A001M
...
@Hitret id=10761
@Talk name=心の声
; 昼食はいつもパンか何かで済ませてる六兵衛にとっては␤ごちそうだったんだろう。
对于午饭一直都是吃面包之类的六兵卫来说，
这应该是顿大餐吧。
@Hitret id=10762
@char file=CI02A005M
...
@stopBgm fade=3000
@Talk name=心の声
; だけど、今打ち明けなかったらこの先打ち明け辛く␤なるのは必至だ。
但是，现在不坦白的话，以后肯定会更难的。
@Hitret id=10766
@Talk name=良太
; 「実は、俺と八雲姉は付き合ってるんだ」
...
; 「ちょっとしたお買い物も『デート』って呼んじゃう␤お付き合いですっ！」
...
@Hitret id=10776
@Talk name=心の声
; やっと覚醒した六兵衛が、フェンスに留まっていた鳥が␤飛び立つくらいの大声を出す。
终于醒悟过来的六兵卫，
发出了仿佛栅栏上的鸟儿被吓跑般的声音。
@Hitret id=10777
@stopSe fade=1000
...
@Hitret id=10781
@Talk name=心の声
; これからゆっくり理解してもらえるようにしよう、そんな␤風に考え始めた矢先だった。
我还正指望着六兵卫接下来慢慢理解呢。
@Hitret id=10782
@char file=CI02A001M
...
@Hitret id=10783
@Talk name=心の声
; 六兵衛の表情は曇り一つなく、無理して言ってるわけじゃ␤ないようだった。
...
; 「そりゃ驚いたけど、親友に彼女が出来たら驚くのは␤当たり前だろ。相手が誰であろうともさ」
「那当然是会吃惊了，自己的挚友有了女朋友
当然会吃惊了。不管对方是谁都一样」
@Hitret id=10786
@Talk name=良太
...
; 「付き合いが長ければ、間宮家の良太中心っぷりは␤十分分かってるしな……むしろ、なにを今さらって␤ところだ」
「毕竟是这么多年的老朋友了，
...
@Hitret id=10789
@Talk name=心の声
; 八雲姉の恋人になった今、改めて言われると結構複雑な␤気分になるな……
如今成为了八云姐姐的恋人，再被这么说的话
心情还真是复杂啊……
@Hitret id=10790
@char file=CI02A010M
@Talk name=六兵衛 voice=RKB010034
; 「でも、四条院さんとの勝負はどうなったんだ？　もう␤借金は返済できたのか」
「但是，和四条院同学赌局的胜负如何？
已经可以还清借款了吗」
@Hitret id=10791
@Talk name=良太
...
; 「ですが、夏休みの終わりまでには返済できるという␤報告を、きちんとした書類付きで見せてもらいました␤から」
「不过，他们给出的报告书我已经拜读过了，
不出意外的话暑假结束之前是能还清接款的，
@Hitret id=10793
@char file=CA02A001M
@Talk name=八雲 voice=YKM010618
; 「私も見せてもらいました。それで結果の前借りみたいな␤ものを認めてもらったんです」
「我也看过了。好像是把报告书的结果
当作了预付款的样子」
@Hitret id=10794
@char file=CI02A006M
@Talk name=六兵衛 voice=RKB010035
; 「よくそんな決断したなあ。教室であんなに大胆な啖呵␤切ったのに」
「还真能作出这样的决断啊。
...
; 「ですが……もう心に決めた人がいるなら、それを␤曲げさせようとは思いません」
「但是……如果良太已经心有所属的话，
我也不会夺人所爱」
@Hitret id=10797
@char file=CE02A011M
@Talk name=莉里香 voice=RRK010043
; 「私の好きになった人が、すぐに相手を乗り換えるような␤不埒な人だなんて嫌ですもの。一度決めたら、一途に␤貫いていただきますわ」
「我可不希望自己喜欢的人是那种喜新厌旧的渣男。
一旦决定自己的选择，就请永远地贯彻下去」
@Hitret id=10798
@Talk name=心の声
; つっけんどんに言ってるけど、四条院さんなりに祝福␤してくれてるんだ。
虽然是态度有些冷淡，
但四条院同学也是在以自己的方式在祝福我们吧。
@Hitret id=10799
@Talk name=心の声
; みんなの前でも、こうしてはっきりと、認めてくれて␤るんだ……
...
; 「それはそれ、これはこれです。私との勝負に勝てない␤程度の愛なんて、認めることなどできませんから！」
「认同你们是一码事，赌局的胜负是另一码事。
...
; 「なんですの、おだてられたからといって、あなたに␤なびいたりしませんわよ」
...
@Hitret id=10812
@Talk name=心の声
; 音琴がぴとりとくっつくのを避けようとせずに、困った␤顔をしながらも受け入れていた。
音琴并没有躲开四条院同学的紧靠，
而是一脸困惑地接受了这般冲击。
@Hitret id=10813
@stopSe fade=1000
...
; 「お前なら、全員ひっくるめてハーレムを築き上げると␤思ってたよ！」
「如果是你的话，肯定是把所有人都收入囊中，
组建自己的后宫吧！」
@Hitret id=10816
@Talk name=良太
...
; 「六兵衛の品性は置いておいて。良太、もう身近な人には␤全員報告したってことよね？」
「先别管六兵卫的本性难移了。
良太，身边的人已经全部报告完了吧？」
@Hitret id=10822
@Talk name=良太
...
; 「失礼ですわね。べ、別にお二人を祝福するためじゃ␤ないんですから。水泳部の表彰を祝うってことですわ」
...
; 「じゃあ、お店が終わったらにしませんか？　それなら␤お料理とか仕込んでおけるから」
「那就等店里的工作结束之后吧？
这样我也好准备一下料理」
@Hitret id=10830
@char file=CA02A006M
...
; 「おお、豪華だな！　昼に続いて夜も美味い物が␤食べられるなんて楽しみだ！」
「哦哦，这么豪华的吗！
继中午之后晚上也能吃到这么美味的食物，
真是太幸福了！」
@Hitret id=10833
...
; 「そうですねっ！　白井くんが来ないと、本当に␤良ちゃんのハーレムが完成しちゃいますから」
「是啊！　要是白井同学不来的话，
小良可就真的要建成他的后宫了」
@Hitret id=10838
@Talk name=良太
...
@Hitret id=10840
@Talk name=心の声
; 父さんと母さんに、閉店後にみんなで集まることを␤連絡すると、快くオーケーをもらえた。
和爸爸妈妈说明了关店后一起庆祝的事后，
他们也很快地同意了。
@Hitret id=10841
@Talk name=心の声
...
@Talk name=心の声
; 学園に用事がある八雲姉や萌莉たちと別れ、俺は␤京花先生を探すことにした。
...
@Hitret id=10845
@Talk name=心の声
; 本来は午前中までなんだから、早めに見つけないと␤帰ってしまうかもしれない。
本来应该中午之前就去找的，
因为要是不早点去的话，老师可能就回家了。
@Hitret id=10846
@Talk name=心の声
; メール連絡で済むには済むけど、良い事は直接伝えた方が␤いいだろう。
虽然只要用邮件联系一下就好了，
但是这种好事还是面对面说一下比较好吧。
@Hitret id=10847
@Talk name=心の声
...
; 「呼び出されてたのは事実だけど、悪いことをしたからじゃ␤ないわ」
...
@Hitret id=10859
@Talk name=心の声
; 京花先生に問題があるとは思えないけど、心配して␤しまった。
虽然我并不认为京花老师会有什么问题，
但还是有些担心。
@Hitret id=10860
@char file=CF03A002M
@Talk name=京花 voice=KYK010033
; 「大丈夫よ。だって私、良太くんにまだなにもして␤ないもの」
「没关系哦。毕竟我还没有对良太做些什么嘛」
@Hitret id=10861
@メッセージ揺らし
@Talk name=良太
...
@Hitret id=10866
@Talk name=心の声
; 教師陣の話だろうし、生徒が詳しく聞いていい話じゃ␤ないだろう。
应该是老师们的话题吧，
作为学生还是别太详细地询问了。
@Hitret id=10867
@Talk name=良太
...
@Hitret id=10874
@Talk name=心の声
; 俺が慌てているのも構わず、京花先生はにこにこ␤微笑んだままだった。
...
@Hitret id=10878
@Talk name=良太
; 「違うんだ。今日、店で晩ごはんを食べていってほしいん␤だけど、用事はある？」
「不是的。今天的晚饭希望你能来店里吃，有时间吗？」
@Hitret id=10879
@char file=CF03A001M
@Talk name=京花 voice=KYK010040
; 「良太くんのお誘いなら喜んで受けるわ。明日は学園の␤お仕事もないから、後片付けまでゆっくり手伝うわね」
「既然是良太的邀请的话我当然乐意啦。
明天学校没有什么工作，关店后的收拾我也可以帮你们哦」
@Hitret id=10880
@Talk name=良太
; 「片付けの心配はしなくていいよ。来てくれるだけで␤いいんだ」
「收拾就不劳费心了。能来参加就好了」
@Hitret id=10881
@char file=CF03A004M
@否定 id=京花
@Talk name=京花 voice=KYK010041
; 「あら、そういうわけにはいかないわ。お料理は␤エキスパートがいるから、せめて他のことを␤お手伝いしたいって思うのよ」
「啊啦，这样可不行哦。料理方面有大厨师准备，
所以至少让我在其他的方面帮帮忙吧」
@Hitret id=10882
@Talk name=良太
; 「本当に、来てくれるだけで嬉しいんだ。八雲姉の␤お祝いでみんな集まるからさ」
「没事的，只要能来就已经很让人开心了。
大家都是为八雲姐姐庆祝而来的哦」
@Hitret id=10883
@char file=CF03A008M
...
@Hitret id=10885
@Talk name=良太
; 「ほら、水泳部で活躍しただろ。だから、みんなで␤お祝いしようと思って」
「你看，她在游泳部不是表现非常出色吗。
所以我们就想着为她庆祝一下」
@Hitret id=10886
@char file=CF03A007M
@Talk name=京花 voice=KYK010043
; 「あら、私はてっきり良太くんと八雲ちゃんのカップル␤成立記念のお祝いかと思ったわ」
...
; 「そうね……私は、良太くんが幸せなのがなによりの␤望みだから……従姉妹として、守ってあげないとね」
...
; 「私は残りのお仕事を終わらせてくるわ。お祝いをする␤なら、準備を手伝えた方が良いものね」
「等我把剩下的工作做完吧。
...
@Hitret id=10900
@Talk name=心の声
; このお祝いは表向き八雲姉だけのお祝いだけど、話の␤発端は俺たちの交際報告だった。
这次的庆祝虽然表面上是为了八雲姐姐，
但是话题的起源却是我们向大家报告交往的事。
@Hitret id=10901
@Talk name=心の声
; だからきっと、みんなは俺たちのことを祝ってくれる␤つもりなんだろう。
所以大家肯定是想为我们庆祝的吧。
@Hitret id=10902
@stopSe fade=1000
@stopBgm fade=3000
...
; 「八雲ちゃんのお祝いのために、こんなに豪華なお料理を␤用意してくださるなんて感激だわぁ。ありがとうねぇ」
「为八雲的庆功会准备了这么豪华的料理，
真是太感谢了。谢谢你」
@Hitret id=10907
@char file=CA03A007M
...
; 「生クリームとチョコクリームのケーキだよ。他にも␤いろいろあるからね」
...
; 「うふふ、育ち盛りの男の子が三人もいるんだから␤大丈夫よぉ」
「嗯哼哼，有三位还在长身体的男孩子在的没关系哦」
@Hitret id=10921
@char file=CG03A007M
@ううっ id=小次郎
@Talk name=小次郎 voice=KJR010026
; 「男の子ってまさか、オレのこともカウントしてるのか␤陽菜さん！？」
「男孩子，难不成，我也是其中之一吗阳菜！？」
@Hitret id=10922
@char file=CH03A002M
...
@Hitret id=10925
@Talk name=心の声
; その子どもである俺と八雲姉も、いつかこんな風に␤所構わずイチャイチャするようになるんだろうか……
我和八雲姐姐作为他们的孩子，
也许有朝一日我们也会变得像他们一样，
在任何场合都能卿卿我我的吧……
@Hitret id=10926
...
; 「私との勝負は正式に終わってないんですのよ！␤今日のお祝いはあくまで水泳の結果のお祝いという␤名目なんですからねっ！」
「我们的赌局还没有决出胜负哦！
今天的活动只不过是为了庆祝
八雲在游泳部的取得的成绩好吧！」
@Hitret id=10935
...
@clearChar id=-1
@Talk name=心の声
; 四条院さんはやけ食いのようにホールケーキを独り占め␤して食べ出した。
四条院同学独占了一整个蛋糕，
开始暴饮暴食了起来。
@Hitret id=10938
@char file=CA03A002M
...
@char file=CA03A007L
@Talk name=心の声
; だけど、八雲姉がこんな風にキラキラと笑っていてくれる␤ように、自分の道をしっかり進まないといけない。
但是，为了让八雲姐姐能够一直这样闪闪发光地笑下去，
我也必须坚定自己的道路并走下去啊。
@Hitret id=10953
@Talk name=心の声
; 八雲姉の輝きに負けないように、俺も自信を持たないと␤いけない。
...
@時間経過２ bg=BG01c01
@Talk name=心の声
; パーティーを終えて、車で帰る四条院さんと、歩きで帰る␤六兵衛をみんなで見送った。
派对结束后，我们目送着
坐车的四条院同学和步行的六兵卫回去。
@Hitret id=10956
@char file=CH03A001M
@Talk name=陽菜 voice=HRN010029
; 「さてと！　じゃあお父さん、お客さま用のお布団を␤客間に運んでくれるかしら」
...
; 「私も手伝うね。シーツとか、枕カバーとか、洗って␤あるの出さないと」
...
@Hitret id=10963
@Talk name=心の声
; 明日は学園の仕事もないということで、京花姉さんは␤泊まっていくことになった。
由于明天学校没有工作，京花姐姐决定留下来过夜。
@Hitret id=10964
@Talk name=心の声
; 京花姉さんが泊まるのは久々だから、みんなどこか␤嬉しそうだ。
...
@Hitret id=10984
@Talk name=心の声
; 海の家を始めたばかりの頃、店の売り上げのことを聞く␤ために萌莉と出かけたことがあった。
海之家刚刚开始步入正轨的时候，
当时为了了解店里的销售情况，
我邀请萌莉一起出去过。
@Hitret id=10985
...
@Hitret id=10999
@Talk name=心の声
; 車も通らない静かな道を二人で歩いていると、世界が␤二人だけのものになったかのようだ。
在没有车辆通行的寂静街道上散步，
仿佛整个世界只属于我们二人一样。
@Hitret id=11000
@char file=CA03A006M
...
; 「ねえねえ、せっかくですから、ちょっと寄り道して␤行きませんか？」
「呐呐，难得的机会，稍微绕绕远路怎么样？」
@Hitret id=11001
@Talk name=良太
; 「寄り道？」
...
@Hitret id=11012
@Talk name=心の声
; みんなの真意は、きっと八雲姉の言う通り俺たちを祝福␤してくれてたんだと思う。
至于大家的真实想法，
我想应该确实和八雲姐姐说的一样，
是为了祝福我们吧。
@Hitret id=11013
...
; 「えへへ、母なる海って言いますもんね。生まれる前も、␤きっとこういう風にくっついてたから……だから␤安心するのかもしれません」
「诶嘿嘿，这就是为什么说大海是母亲吧。
...
; 「時々、こうやって夜にデートしましょうか。きっと␤楽しいですよ」
...
@Hitret id=11035
@Talk name=心の声
; それでも八雲姉に劣等感を抱かずに済んでるのは、きっと␤目標ができたからだ。
但是，我没有因此而产生自卑感，
一定是因为我也找到了我的目标吧。
@Hitret id=11036
@Talk name=心の声
...
@Hitret id=11039
@Talk name=良太
; 「いつか、八雲姉にも『敵わない』って言ってもらえる␤ように、頑張ろうと思ってさ」
「我在想，总有一天，我要让八雲姐姐也
对我说出：“真敌不过你啊”这样的话来」
@Hitret id=11040
@char file=CA03A002L
@Talk name=八雲 voice=YKM010643
; 「心から好きな時って『参ってる』って言い方します␤よね？　それなら私は、もう十分良ちゃんに参って␤ますよ」
「发自内心喜欢着对方的时候，
会说“真是败给你了”这样的话不是吗？
这样的话，其实我已经完全败给小良了哦」
@Hitret id=11041
...
@Hitret id=11045
@Talk name=心の声
; 八雲姉は驚いて身体を震わせたものの、すぐ嬉しそうな␤吐息を漏らした。
八雲姐姐惊讶得一时有些颤抖，
但很快便漏出了愉悦的吐息。
@Hitret id=11046
@Talk name=心の声
...
@Hitret id=11052
@Talk name=良太
; 「さっきまでは甘い感じだったけど、今は別の意味で␤ドキドキしてきたよ」
「刚才还是甜蜜的感觉，
但现在却是另一种意义上的心跳加速了」
@Hitret id=11053
@char file=CA03A006L
...
@Hitret id=11067
@Talk name=心の声
; このまま時間が止まってしまいそうなほど、意識は甘く␤蕩けていった。
仿佛时间停止了一般，意识变得甜蜜而迷离。
@Hitret id=11068
@stopEnvSe fade=1000
