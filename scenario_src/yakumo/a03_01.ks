...
「就是啊。所以听说了今天要比赛的事，
我才做了便当，然后和八云酱说了放在冰箱里的……」
@Hitret id=9541
@Talk name=良太
@Sub mess="「なるほど。水泳部の助っ人って、午後まであるのか」"
「原来如此。八云姐姐去游泳部帮忙，要一直到下午吗？」
@Hitret id=9542
@char file=CC06A006M
...
八云姐姐像是要掩饰什么一样说个不停的样子，
真是可爱呢。
@Hitret id=9608
@Talk name=良太
@Sub mess="「お弁当届けに来たんだ。八雲姉、忘れてっただろ？」"
「我是来送便当的哦。八云姐姐，你忘了这个吧？」
@Hitret id=9609
@char file=CA02A014M
@Talk name=心の声
