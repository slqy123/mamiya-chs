...
@Hitret id=16147
@Talk name=心の声
; すっかり『萌莉のことは俺へ』という構図ができてる␤みたいだ。
好像是在说『萌莉的事那肯定和你有关吧』。
@Hitret id=16148
@clearChar id=-1
@char file=CB06A006M
@Talk name=萌莉 voice=MER020667
; 「明日から本格的な夏休みに入るから、改めて␤いろいろ確認しておこうと思うの」
...
@clearChar id=-1
@Talk name=心の声
; びっしりと表や数字が書かれたページが、何ページも␤続いている。
...
; 「すごい量ですよ……ここまでまとめるの大変だった␤でしょう？」
「真是不得了的工作量啊……做到这个地步也太辛苦了吧？」
@Hitret id=16154
@char file=CB06A006M
@否定 id=萌莉
@Talk name=萌莉 voice=MER020669
; 「いつもやってることだもの。それに四条院さんが␤来てから、コツコツまとめ進めてたのよ」
...
@clearChar id=-1
@Talk name=心の声
; みんなでファイルをのぞきこみながら、数字の意味を␤読み取ろうとする。
大家一边看着文件的内容，一边理解着其中数据的含义。
@Hitret id=16157
@char file=CG06A004M
@Talk name=小次郎 voice=KJR020040
; 「それで……だ。萌莉、オレたちはこれでなにを␤確認すればいいんだ？」
「啊……对了。萌莉，叫我们来是要确认什么呢？」
@Hitret id=16158
@char file=CB06A002M
...
@Hitret id=16169
@Talk name=心の声
; 萌莉が経理を教わり始めた頃といえばつまり、俺含めた␤子どもたちの手がかからなくなってきた頃ってことだ。
说起萌莉开始学当会计的时候，那个时候我们才刚刚开始不需要照顾吧。
@Hitret id=16170
@Talk name=心の声
; 手間をかけさせていた張本人である俺たちが責められる␤はずもない。
...
; 「ええ。夏によく注文されてるメニューを一覧にしたの。␤飲み物だけっていうお客さまが多かったり、注文される␤料理も結構偏りがあるのよ」
「是的。我把夏天经常点的东西列了一张表。点饮料的客人占比很多，而且客人们点的料理也体现出很强的偏好性」
@Hitret id=16173
@Talk name=良太
; 「意外とカレーとか、スタミナがつきそうなメニューも␤売れてるんだな」
...
; 「夏はお家でお料理すると暑くて大変でしょ？　そうめん␤ゆでるのだって、湯気で汗だくになっちゃうから」
...
@Hitret id=16176
@Talk name=心の声
; 昼ごはんのまかないや晩ごはんの準備を手伝うことも␤あるけど、コンロの火を使う料理はこの時期ひと苦労だ。
我有时也会帮家里准备午饭和晚饭，需要用到炉火的时候却实很辛苦啊。
@Hitret id=16177
@char file=CC06A006M
@Talk name=珠音 voice=TMN020036
; 「お家で作るのが大変な、火を使うお料理をお外で食べる␤お客さまが多いんだね」
...
; 「だから、お父さん考案の新メニューが␤パスタなのは、大正解なのよ」
「所以，爸爸设计的意大利面新料理，是绝对的正解呢」
@Hitret id=16179
@char file=CG06A006M
@ジャンプ id=小次郎
@Talk name=小次郎 voice=KJR020041
; 「ははは、そうだろうそうだろう。父さんにはちゃんと␤分かってたぞ！」
「哈哈哈，是吧是吧，你爸爸我早就知道了！」
@Hitret id=16180
@char file=CB06A011M
@Talk name=心の声
...
; 「えっと、じゃあお料理の材料はこの表を中心に␤仕入れてもらえばいいんだね」
「嗯，既然如此，料理的原料就以这张表为中心去进货吧」
@Hitret id=16183
@char file=CB06A011M
@Talk name=萌莉 voice=MER020677
; 「そうなるわね。あらかじめ注文する数が予想できて␤いれば、仕入れの値段交渉もしやすくなるかなって␤思うのよ」
...
; 「でも、もっと前からこういう風にデータを使っていれば、␤四条院さんに目を付けられなかったんじゃない␤でしょうか？」
...
; 「それは違うわよ八雲ちゃん。切羽詰まった事情に背中を␤押されたからこそ、こうしてお披露目してくれたん␤でしょう？」
...
; 「本当は、これもまだ完全じゃないの。過去のデータが␤少なすぎるし、不確定要素があるんだもの」
「其实，这也不能完全保证。因为过去的数据太少了，不确定的要素也很多」
@Hitret id=16196
@Talk name=心の声
; こんなにびっしり計算してるのに、何が不確定要素␤なんだろう。
...
; 「この計算は全部、天気が晴れの時用の数字なの。だから、␤もし雨が長く降ったりした時は目標に届かない日も␤出てくるわ」
「这些计算全都是建立在天气晴朗的基础上的。所以，如果出现长时间的降雨的话，肯定会有达不到目标的日子的」
@Hitret id=16206
@char file=CB06A006M
@Talk name=萌莉 voice=MER020685
; 「そういう時はチェックして計算し直すし、一応、␤雨が何日か降った時のために、少し余裕を␤持たせてるけど……」
...
; 「な、なんだ、そうなの。別に覗いたりしないけど、␤いかがわしいサイトを慌てて消しただけとかじゃない␤わよね？」
...
@Hitret id=16228
@Talk name=良太
; 「いや、大丈夫だ。ちょっとお風呂で考えたいことも␤あるし」
「不用的，我没事。正好我也想去浴室里想点问题」
@Hitret id=16229
@char file=CB03A008M
@ジャンプ id=萌莉
@Talk name=萌莉 voice=MER020694
; 「駄目よ！　そ……そういうの、お風呂に流すと排水溝が␤詰まっちゃうから」
...
@Hitret id=16232
@Talk name=良太
; 「これからの天気のことを調べてたんだ。結構先まで␤天気予報が載ってるサイトもあるから」
...
@Hitret id=16234
@Talk name=良太
; 「ああ。でも天候だけはどうしようもないから、心の準備␤だけでもした方がいいだろ」
...
; 「やっぱり、雨が降りそう？　私も調べたけど、結構␤長引きそうよね」
...
@Hitret id=16239
@Talk name=良太
; 「今年は集中豪雨も多いらしいんだ。すごく暑い日が␤数日続いたら要注意だってさ」
...
@Hitret id=16241
@Talk name=良太
; 「観光客は『せっかくの旅先だから』って雨でも外に␤出てくれるけど、常連の人は外出しなくなっちゃう␤もんな」
「游客可能会觉得“难得来这里旅游一次”，就算下雨也会出门，但是常客们基本上都不会外出了吧」
@Hitret id=16242
@char file=CB03A009M
@おじぎ id=萌莉
@Talk name=萌莉 voice=MER020698
; 「そうね。それに観光のお客さまもホテルのカフェで␤過ごすようになっちゃうと思うのよね」
「是啊。而且就算是游客，也会更倾向于待在酒店点杯咖啡度过吧」
@Hitret id=16243
@Talk name=良太
; 「ああ。晴れの日に頑張るのはもちろんだけど、雨の日の␤対策も考えないといけないな」
