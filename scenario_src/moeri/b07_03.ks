...
「哦哦，还真是热烈啊。比起刚才，
现在的这个样子才是真的烫伤吧」  ; {COMMENT 指脸红的样子和烫伤一样}
@Hitret id=16818
@char file=CD03B012M
...
「啊……嗯，那个，那种笑话我也很擅长哦。
一张座垫……什么的，啊哈哈……」
{BLOCK_COMMENT 来源于日本的ー个叫「笑点」的电视节目。参加该节目的人打诨非常精彩的时候，就会得到一张座垫}
@Hitret id=16821
@char file=CD03B009M
@おじぎ id=音琴
...
『八云姐姐，说这种话会被马踢的。
要说一对情侣深更半夜悄悄出门还能去干什么的话……』  ; {COMMENT 馬に蹴られる：指妨碍他人恋爱的行为}
@Hitret id=17050
@face file=CA03A003M
@メッセージ揺らし
