...
; 「家族みんなとの思い出も作ってくれて、ありがとう␤ございますっ！」
「为我们全家留下了美好的回忆，谢谢你！」
@Hitret id=38261
@clearChar id=-1
@char file=CC03A006M
...
; 「えっと、突然ですがゲームクリアで解放される機能の␤ご紹介です」
「嗯，虽然很突然，
接下来是游戏通关后解锁功能的介绍」
@Hitret id=38262
@char file=CB03A011M
...
; 「変更できる衣装の種類、萌莉お姉ちゃんには␤知らせてないんだよね」
...
; 「衣装って、デート着とかドレスとか、私たちが␤可愛くなるものなんでしょう？」
...
; 「こうして、ゲーム中どんな場面でも水着姿で␤進行できちゃいます」
...
; 「そうですわ、こんな格好で学園生活を送るなんて␤恥ずかしすぎますっ！」
...
; 「そういうわけですから、ちょっと変わった␤『間宮くんちの五つ子事情』を遊んでみて␤くださいね」
「事情就是这样了，就请试玩一下
稍微变化了一些的《间宫家的五子情事》吧」
@Hitret id=38294
@char file=CD03B011M
...
; 「どうしてもって言うなら水着でも裸でも過ごして␤あげるけど……その代わり、ちゃんと責任取って␤水着と裸で私のルートをキッチリ二周しなさいよ」
...
; 「そうですわ、私のありがたい言葉をひと言も␤聞きもらさないようにしてくださいっ！」
「是啊，我对你感谢的话语，你一句都不能给我听落下」
@Hitret id=38298
@clearChar id=-1
@char file=CA03A001M
@Talk name=八雲 voice=YKM000612
; 「ちなみに、この機能は『立ち絵』が変化するだけで␤イベントＣＧやテキストは全く変わりませんので、␤ご了承ください」
「顺带一提，这个功能只是单纯地改变“立绘”，
游戏的功能，事件和CG完全没有变话，敬请谅解」
@Hitret id=38299
@char file=CC03A008M
...
; 「私たちの水着姿や裸は、あなたにしか見えない␤設定ってことで、よろしくお願いね」
「我们的泳衣和裸体是只有你才能看到的设定，
请多关照哦」
@Hitret id=38301
@clearChar id=-1
